...
class ValidationError(HyperliquidMCPError):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_type="ValidationError", details=details)
...
class APIError(HyperliquidMCPError):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_type="APIError", details=details)


class PrecisionError(HyperliquidMCPError):
    """Error raised when decimal precision validation fails."""

    def __init__(self, message: str, symbol: str, value: float, constraint: str):
        """
        ...
        super().__init__(
            ...
            details={"symbol": symbol, "value": value, "constraint": constraint},
        )
...
class InsufficientBalanceError(HyperliquidMCPError):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, error_type="InsufficientBalanceError", details=details
        )
...
class LeverageExceededError(HyperliquidMCPError):
    ...
    def __init__(self, symbol: str, requested_leverage: int, max_leverage: int):
        """
